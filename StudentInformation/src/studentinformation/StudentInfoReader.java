...
{
        studentinformation.StudentInfoNode root;
        studentinformation.StudentInfoNode checkNode;
        studentinformation.StudentInfoNode parent;

        public void addNode(studentinformation.StudentInfoNode newNode)
        {
    ...
    public studentinformation.StudentInfoNode fetchStudent(int key)
    {
        studentinformation.StudentInfoNode currentNode = root;
        while (true)
        {
    ...
    public boolean showAllRecords(studentinformation.StudentInfoNode currentNode)
    {
        if (currentNode == null)
        {
...
//added this method to try to break some of the logic out of the already massive delete method
    public studentinformation.StudentInfoNode getParent(int key)
    {
        studentinformation.StudentInfoNode currentNode = root;
        parent = currentNode;
        while (true)
    ...
    public void updateNode(int key, studentinformation.StudentInfoNode newStudent)
    {
        deleteNode(key);
        addNode(newStudent);
    }
