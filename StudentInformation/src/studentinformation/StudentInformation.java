//File name is StudentInformation
...
public class StudentInformation
{
    public static void main(String[] args)
    {
        displayClassInfo();
        int choice = 0;
        StudentInfoReader binarySearch = new StudentInfoReader();
        StudentInfoNode newStudent;
        while (choice != 6)
        {
            ...
            if (choice == 1)
            {
                ...
                newStudent = newStudent(studentId,studentName,studentGpa);
            ...
            if (choice == 2)
            {
               ...
               StudentInfoNode student = binarySearch.fetchStudent(studentFind);
            ...
            if (choice == 4)
            {
                ...
                newStudent = new StudentInfoNode(newStudentId,updateStudentName,newStudentGpa);
    ...
    {
        System.out.println(" Super Complex Coding Class,");
    }
    ...
    private static StudentInfoNode newStudent(int studentId, String studentName, double studentGpa) {
